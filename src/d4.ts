...
type D4TownPortalCosmetic = D4Ref &
  D4Type & {
    hIconImage: number;
    eClassRestriction: number;
  };

type D4MarkingShape = D4Ref &
  D4Type & {
    hIconImage: number;
    eClassRestriction: number;
  };
...
type D4Translation = D4Ref &
  D4Type & {
    arStrings: D4String[];
  };

type D4PlayerTitle = D4Ref &
  D4Type & {
    bIsSeasonal: boolean;
  };

type D4ChallengeDefinition = D4Ref &
  D4Type & {
