...
export function playerTitleFactory(deps: D4Dependencies, media: Map<string, number>): (item: D4PlayerTitle) => StrapiItemReq {
    return (title: D4PlayerTitle): StrapiItemReq => {
